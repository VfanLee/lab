module.exports = {
  ...
  resolve: {
    ...
    modules: [
      ...
      'vue-cli/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
      'vue-cli/node_modules/@vue/cli-plugin-babel/node_modules',
      'vue-cli/node_modules/@vue/cli-service/lib/config/vue-loader-v15-resolve-compat',
      'node_modules',
      'vue-cli/node_modules',
      'vue-cli/node_modules/@vue/cli-service/node_modules'
    ]
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: 'vue-cli/node_modules/@vue/vue-loader-v15/lib/index.js',
            options: {
              compilerOptions: {
                whitespace: 'condense'
              }
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: 'vue-cli/node_modules/mini-css-extract-plugin/dist/loader.js',
                options: {
                  publicPath: '/'
                }
              },
              ...
              {
                loader: 'vue-cli/node_modules/css-loader/dist/cjs.js',
                options: {
                  sourceMap: false,
                  importLoaders: 2,
                  modules: {
              ...
              {
                loader: 'vue-cli/node_modules/postcss-loader/dist/cjs.js',
                options: {
                  sourceMap: false,
                  postcssOptions: {
                    plugins: [
        ...
        oneOf: [
          /* config.module.rule('scss').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: 'vue-cli/node_modules/sass-loader/dist/cjs.js',
                options: {
                  sourceMap: false
                }
              }
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          ...
          {
            loader: 'vue-cli/node_modules/thread-loader/dist/cjs.js'
          },
          /* config.module.rule('js').use('babel-loader') */
          {
            loader: 'vue-cli/node_modules/babel-loader/lib/index.js',
            options: {
              cacheCompression: false,
              cacheDirectory: 'vue-cli/node_modules/.cache/babel-loader',
              cacheIdentifier: '3ea56cb0'
            }
          }
        ]
      }
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: 'vue-cli/public/index.html'
      }
    ),
    /* config.plugin('copy') */
    new CopyPlugin(
        ...
        patterns: [
          {
            ...
            globOptions: {
              ignore: [
                '**/.DS_Store',
                'C:/Users/vfanlee/Desktop/workspace/lab/demo/vue/vue-cli/public/index.html'
              ]
            },
            info: {
              minimized: true
